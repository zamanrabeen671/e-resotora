...
export const Sidebar = ({ sidebarOpen, setSidebarOpen }: TProps) => {
  ...
  useEffect(() => {
    ...
    if (sidebarExpanded) {
      let bl = document.querySelector("body") as HTMLElement;
      bl.classList.add("sidebar-expanded");
      //   document.querySelector('body').classList.add('sidebar-expanded') as HTMLElement;
    } else {
      let bl = document.querySelector("body") as HTMLElement;
      bl.classList.remove("sidebar-expanded");
